package top.twindworld.lottery.domain.strategy.service.draw.impl;
...
import top.twindworld.lottery.domain.strategy.service.draw.AbstractDrawBase;
...
public class DrawExecImpl extends AbstractDrawBase {
    ...
    protected List<String> queryExcludeAwardIds(Long strategyId) {
        ...
        logger.info("执行抽奖策略 strategyId：{}，无库存排除奖品列表ID集合 awardList：{}", strategyId, JSONUtil.toJsonStr(awardList));
        return awardList;
    }
